...
namespace MVPMusicBox
{
    ...
    public class MusicBoxCommand : ICommand,IUsageProvider
    {
        public Player admin;
        public string Command { get; } = "musicbox";
        public string[] Aliases { get; } = new string[1] { "musicbox" };
        public string Description { get; } = "调试音乐盒";
        public string[] Usage { get; } = { "Id","Index"};
            ...
            if (sender is PlayerCommandSender playerCommandSender)
            {
                ...
                if (arguments.Count >= 1) 
                {
                    try 
                    {
                        ...
                        {
                            MVPMusic.MusicBoxPlayer(player,i);
